...
public class SalaireDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private SalaireDAO dataStore;

	/**
	 * Instantiates a new SalaireDAOTest.
	 *
	 */
	public SalaireDAOTest() {
	}

	/**
	 * Method to test Salaire domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Salaire() {
		Salaire instance = new Salaire();
	 ...
	 */
	@Autowired
	public void setDataStore(SalaireDAO dataStore) {
