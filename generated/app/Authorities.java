...
@XmlType(namespace = "Gestion_ressource_humaine/app", name = "Authorities")
public class Authorities implements Serializable {
	...
	public Set<Users> getUser() {
		if (user == null) {
			user = new java.util.LinkedHashSet<app.Users>();
		}
		return user;
	}
	...
	public void copy(Authorities that) {
		...
		setUser(new java.util.LinkedHashSet<app.Users>(that.getUser()));
	}
