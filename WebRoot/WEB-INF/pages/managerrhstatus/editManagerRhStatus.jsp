...
<html>
<head>
<title>Edit <fmt:message key="managerrhstatus.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveManagerRhStatus" method="POST" modelAttribute="managerrhstatus">
