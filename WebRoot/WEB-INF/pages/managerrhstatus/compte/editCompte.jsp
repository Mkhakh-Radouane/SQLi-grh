...
<html>
<head>
<title>Edit <fmt:message key="managerrhstatus.title"/> <fmt:message key="compte.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveManagerRhStatusCompte" method="POST" modelAttribute="compte">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="managerrhstatus_id" value="${managerrhstatus_id}" >
