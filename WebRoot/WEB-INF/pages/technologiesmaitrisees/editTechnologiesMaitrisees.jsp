...
<html>
<head>
<title>Edit <fmt:message key="technologiesmaitrisees.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveTechnologiesMaitrisees" method="POST" modelAttribute="technologiesmaitrisees">
