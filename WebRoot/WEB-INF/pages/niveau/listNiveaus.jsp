...
<html>
<head>
<title>List <fmt:message key="niveau.title"/>s</title>
</head>
<body>
<div id="contentarea" >
	...
	<div id="content">
		<h1>Manage <fmt:message key="niveau.title"/>s</h1>
		<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/newNiveau"><span><img src="${pageContext.request.contextPath}/images/icons/new.gif" /><fmt:message key="navigation.new"/> <fmt:message key="niveau.title"/></span></a></div>
		<div id="tablewrapper">
