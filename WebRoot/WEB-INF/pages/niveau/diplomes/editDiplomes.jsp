...
<html>
<head>
<title>Edit <fmt:message key="niveau.title"/> <fmt:message key="diplome.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveNiveauDiplomes" method="POST" modelAttribute="diplome">
