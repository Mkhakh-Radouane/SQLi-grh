...
<html>
<head>
<title>Edit <fmt:message key="ecole.title"/> <fmt:message key="diplome.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveEcoleDiplomes" method="POST" modelAttribute="diplome">
